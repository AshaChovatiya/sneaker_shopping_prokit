...
class WishlistProduct extends Model {
  ...
  WishlistProductModelIdentifier get modelIdentifier {
      return WishlistProductModelIdentifier(
        id: id
      );
  }
  ...
  const WishlistProduct._internal({required this.id, required wishlistId, required productId, product, variantId, variant, required quantity, createdAt, updatedAt}): _wishlistId = wishlistId, _productId = productId, _product = product, _variantId = variantId, _variant = variant, _quantity = quantity, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory WishlistProduct({String? id, required String wishlistId, required String productId, Product? product, String? variantId, Variant? variant, required int quantity, TemporalDateTime? createdAt, TemporalDateTime? updatedAt}) {
  ...
  WishlistProduct copyWith({String? wishlistId, String? productId, Product? product, String? variantId, Variant? variant, int? quantity, TemporalDateTime? createdAt, TemporalDateTime? updatedAt}) {
    return WishlistProduct._internal(
      id: id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'wishlistId': _wishlistId, 'productId': _productId, 'product': _product?.toJson(), 'variantId': _variantId, 'variant': _variant?.toJson(), 'quantity': _quantity, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  
  Map<String, Object?> toMap() => {
    'id': id, 'wishlistId': _wishlistId, 'productId': _productId, 'product': _product, 'variantId': _variantId, 'variant': _variant, 'quantity': _quantity, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };

  static final QueryModelIdentifier<WishlistProductModelIdentifier> MODEL_IDENTIFIER = QueryModelIdentifier<WishlistProductModelIdentifier>();
  ...
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.indexes = [
      ModelIndex(fields: const ["wishlistId", "createdAt"], name: "bywishlistIdcreatedAtWishlistProduct")
    ];
 ...
 */
@immutable
class WishlistProductModelIdentifier implements ModelIdentifier<WishlistProduct> {
  final String id;

  /** Create an instance of WishlistProductModelIdentifier using [id] the primary key. */
  const WishlistProductModelIdentifier({
    required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is WishlistProductModelIdentifier &&
      id == other.id;
  }
