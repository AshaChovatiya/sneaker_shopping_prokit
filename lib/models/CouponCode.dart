...
class CouponCode extends Model {
  ...
  CouponCodeModelIdentifier get modelIdentifier {
    return CouponCodeModelIdentifier(id: id);
  }
  ...
  String toString() {
    ...
    buffer.write("discount=" +
        (_discount != null ? _discount!.toString() : "null") +
        ", ");
    buffer.write("expirationDate=" +
        (_expirationDate != null ? _expirationDate!.format() : "null") +
        ", ");
    buffer.write(
        "maxUse=" + (_maxUse != null ? _maxUse!.toString() : "null") + ", ");
    buffer.write("totalUsed=" +
        (_totalUsed != null ? _totalUsed!.toString() : "null") +
        ", ");
    buffer.write("isActive=" +
        (_isActive != null ? _isActive!.toString() : "null") +
        ", ");
    buffer.write("isFeatured=" +
        (_isFeatured != null ? _isFeatured!.toString() : "null") +
        ", ");
    buffer.write("minOrderValue=" +
        (_minOrderValue != null ? _minOrderValue!.toString() : "null") +
        ", ");
    buffer.write("maxDiscount=" +
        (_maxDiscount != null ? _maxDiscount!.toString() : "null") +
        ", ");
  ...
  CouponCode.fromJson(Map<String, dynamic> json)
      : id = json['id'],
        ...
        _store = json['store']?['serializedData'] != null
            ? Store.fromJson(
                new Map<String, dynamic>.from(json['store']['serializedData']))
            : null,
        _userId = json['userId'],
        ...
        _expirationDate = json['expirationDate'] != null
            ? TemporalDate.fromString(json['expirationDate'])
            : null,
  ...
  Map<String, dynamic> toJson() => {
        ...
        'user': _user?.toJson(),
        'discount': _discount,
        'expirationDate': _expirationDate?.format(),
        'maxUse': _maxUse,
  ...
  static final QueryModelIdentifier<CouponCodeModelIdentifier>
      MODEL_IDENTIFIER = QueryModelIdentifier<CouponCodeModelIdentifier>();
  ...
  static final QueryField STORE = QueryField(
      fieldName: "store",
      fieldType:
          ModelFieldType(ModelFieldTypeEnum.model, ofModelName: 'Store'));
  ...
  static final QueryField EXPIRATIONDATE =
      QueryField(fieldName: "expirationDate");
  ...
  static final QueryField MINORDERVALUE =
      QueryField(fieldName: "minOrderValue");
  ...
  static var schema =
    ...
    modelSchemaDefinition.indexes = [
      ...
      ModelIndex(
          fields: const ["userId", "createdAt"], name: "byuserIdCouponCode")
    ];
...
class CouponCodeModelIdentifier implements ModelIdentifier<CouponCode> {
  ...
  const CouponCodeModelIdentifier({required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is CouponCodeModelIdentifier && id == other.id;
  }
